  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      >
        ...
        <span style={{ fontSize: 14, fontWeight: 700, color: colors.textMain }}>{Math.round(v)}%</span>
        ...
        <Row gutter={[40, 32]} align="middle" style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <Col xs={24} lg={12}>
            ...
            >
              ...
              >
                <span style={{ fontWeight: 700, color: colors.textMain }}>Покупатель iPhone 15</span>
